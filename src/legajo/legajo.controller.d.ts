...
export declare class LegajoController {
    private readonly legajoService;
    constructor(legajoService: LegajoService);
    create(createLegajoDto: CreateLegajoDto): Promise<import("./entities/legajo.entity").Legajo>;
    ...
    findOne(id: string): Promise<import("./entities/legajo.entity").Legajo>;
    update(id: string, updateLegajoDto: UpdateLegajoDto): Promise<import("typeorm").UpdateResult>;
